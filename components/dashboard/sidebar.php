<div class="app-container">
    <div class="sidebar">
        ...
        <ul class="">
            <li class="sidebar-list-item <?= (basename($_SERVER['PHP_SELF']) == 'account.php' ? 'active' : '') ?>">
                <a href="account.php">
            ...
            <li class="sidebar-list-item <?= (basename($_SERVER['PHP_SELF']) == 'products.php' ? 'active' : '') ?>">
                <a href="products.php">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="sidebar-list-item <?= (basename($_SERVER['PHP_SELF']) == 'order.php' ? 'active' : '') ?>">
                <a href="order.php">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"

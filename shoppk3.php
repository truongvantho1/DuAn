            ...
            <div class="col-md-9 order-2">
                ...
                <div class="row mb-5">
                    <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                        <div class="block-4 text-center border">
                            <figure class="block-4-image">
                                <a href="shop-single.php"><img src="images/tat6.jpg" alt="Image placeholder"
                                        class="img-fluid"></a>
                            </figure>
                            <div class="block-4-text p-4">
                                <h3><a href="shop-single.php">Tất tháng 11 màu đen</a></h3>
                                <p class="mb-0">sale 0%</p>
                                <div>
                                    <p style="text-decoration: line-through;">22.000đ</p>
                                    <p class="text-primary font-weight-bold">22.000đ</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                        <div class="block-4 text-center border">
                            <figure class="block-4-image">
                                <a href="shop-single.php"><img src="images/tat7.jpg" alt="Image placeholder"
                                        class="img-fluid"></a>
                            </figure>
                            <div class="block-4-text p-4">
                                <h3><a href="shop-single.php">Tất unisex</a></h3>
                                <p class="mb-0">sale 0%</p>
                                <div>
                                    <p style="text-decoration: line-through;">23.000đ</p>
                                    <p class="text-primary font-weight-bold">23.000đ</p>
                                </div>
                            </div>
                        </div>
                    </div>
